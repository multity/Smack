...
import com.example.dtodorov.smack.Model.Message
import com.example.dtodorov.smack.Utilities.URL_GET_CHANNELS
import com.example.dtodorov.smack.Utilities.URL_GET_MESSAGES
...
object MessageService {
    ...
    fun getMessages(chId: String, complete: (Boolean) -> Unit){
        val url = "$URL_GET_MESSAGES$chId"
